  ...
  <div id="hero-carousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-item active">
      <div class="carousel-container">
        <h2 class="animate__animated animate__fadeInDown">Kenya Association of the Intellectually Handicapped</h2>
        <p class="animate__animated animate__fadeInUp">
          We empower lives, advocate for rights, and foster inclusion.
          For two decades, KAIH has been at the forefront of promoting the rights of Persons with Intellectual Disability (PWIDs) and their families. Today, our organization represents over 3,000 members across 10 counties.
          We have trained over 9,700 individuals, including families, representatives from the judiciary, executive, legislative assembly, various government ministries, and civil societies.
        </p>
    ...
    <div class="carousel-item">
      <div class="carousel-container">
        ...
        <p class="animate__animated animate__fadeInUp">To promote the human rights of PWIDs and their families within the society through education, advocacy, empowerment, and information exchange.</p>
        <!-- <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a> -->
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="carousel-container">
        ...
        <p class="animate__animated animate__fadeInUp">A society where the human rights of people with intellectual disabilities and their families are fully recognized.</p>
        <!-- <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a> -->
      </div>
    </div>
